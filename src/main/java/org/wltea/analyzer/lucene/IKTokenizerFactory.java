...
public class IKTokenizerFactory extends TokenizerFactory implements ResourceLoaderAware, UpdateThread.UpdateJob {
    ...
    public void inform(ResourceLoader resourceLoader) throws IOException {
        System.out.println("IKTokenizerFactory " + this.hashCode() + " inform conf: " + getConf());
        System.out.println("IKTokenizerFactory resourceLoader: " + resourceLoader.getClass().getName());
